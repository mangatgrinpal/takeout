...
ActiveRecord::Schema.define(version: 2020_09_04_080841) do
  ...
  create_table "order_customers", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["customer_id"], name: "index_order_customers_on_customer_id"
  ...
  create_table "orders", force: :cascade do |t|
    ...
    t.string "status"
    t.integer "restaurant_id"
    t.decimal "order_price", precision: 6, scale: 2
